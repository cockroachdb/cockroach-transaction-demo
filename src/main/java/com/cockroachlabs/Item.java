...
/**
 * JPA entity that models the items found in the Kwikshoppr database.
 *
...
class Item {
	...
	Item(String name, String description, int quantity, double price) {
		this(null, name, description, quantity, price);
	}

	Item(UUID itemId, String name, String description, int quantity, double price) {
