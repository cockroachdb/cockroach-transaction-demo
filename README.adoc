...
BTW, if you're new to CockroachDB and how it works, be sure to check out https://thesecretlivesofdata.com/raft/[The Raft protocol], the mechanism Cockroach uses to seamlessly replicated and manage your data in a truly distributed fashion.
